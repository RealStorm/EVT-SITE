	...
	<body>
		<div class="container">
			...
			<div class="middle"><h2>Rekrutacja OFF</h2><p class="welcometext">Witaj na oficjalnej stronie firmy Europe Virutal Transport.<p>
				...
				<p class="indextext">Prezesem firmy Europe Virutal Transport jest Marcin (Martinez) Laskowski.
				Wiceprezesem Zarządu oraz księgowym jest Mateusz(Mefiu) Musialik..
				W chwili obecnej zatrudniamy dwudziestu dwóch kierowców, oraz siedmiu kierowców na okresie próbnym.</p>
			</p></div>
			<aside class="right">
